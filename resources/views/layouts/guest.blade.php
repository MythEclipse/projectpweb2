...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 dark:from-[#1a1a1a] dark:to-[#2d2d2d] flex items-center justify-center p-4">
        <div class="w-full max-w-6xl mx-4 bg-white dark:bg-[#1a1a1a] rounded-[2rem] shadow-2xl overflow-hidden flex flex-col min-h-[80vh]">

            <div class="bg-gradient-to-r from-pink-600 to-purple-600 dark:from-[#2d2d2d] dark:to-[#3E3E3A] px-12 py-8">
                <div class="flex items-center justify-between">
                    <a href="/" class="flex items-center gap-4 group transform transition-all duration-300 hover:-translate-y-1">
                        <x-application-logo class="w-16 h-16 text-white dark:text-pink-400 transition-all group-hover:rotate-12" />
                        <div>
