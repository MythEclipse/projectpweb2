...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] min-h-screen">
                ...
                <div class="flex items-center gap-4">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="px-4 py-2 text-sm font-medium transition-all hover:bg-gray-100 dark:hover:bg-[#3E3E3A] rounded-lg">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
    ...
    <!-- Hero Section -->
    <section
        class="relative pt-20 pb-32 px-4 lg:px-8 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-[#1a1a1a] dark:to-[#2d2d2d]">
