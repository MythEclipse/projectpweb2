...
<x-guest-layout>
    ...
    <div class="w-full max-w-md space-y-8">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                            <svg class="w-5 h-5 text-gray-400 dark:text-pink-300" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-between">
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}"
                        class="text-sm font-medium text-pink-600 hover:text-pink-500 dark:text-pink-400 dark:hover:text-pink-300">
                        {{ __('Forgot Password?') }}
                    </a>
                @endif
            </div>
            ...
            <x-primary-button
                class="w-full justify-center bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-lg py-3 rounded-xl">
                {{ __('Sign In') }}
            </x-primary-button>
            ...
            <div class="relative mt-8">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-white dark:bg-[#1a1a1a] text-gray-500 dark:text-pink-300">Or continue
                        with</span>
                </div>
            </div>
