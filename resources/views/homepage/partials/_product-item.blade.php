<div class="bg-white dark:bg-dark-subcard rounded-2xl shadow p-4 flex flex-col items-start hover:shadow-lg transition w-full h-[300px]"
    ...
    <div class="h-32 w-full bg-gray-100 dark:bg-dark-border rounded-xl mb-4 flex items-center justify-center text-gray-400">
        @if ($product->image)
    ...
    <h3 class="text-md font-semibold text-text-dark dark:text-text-light mb-1">{{ $product->name }}</h3>
