            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 px-4 sm:px-0">
                ...
                <div class="flex-shrink-0">
                    ...
                    {{-- <a href="{{ route('admin.transactions.edit', $transaction->id) }}"
                       class="text-sm bg-yellow-500 hover:bg-yellow-600 dark:bg-yellow-600 dark:hover:bg-yellow-700 text-white px-4 py-2 rounded-md transition duration-150 ease-in-out inline-block">
                        Edit Transaksi
                    </a> --}}
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <dl class="space-y-4">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm font-bold text-pink-brand dark:text-pink-brand">Rp {{ number_format($transaction->total, 0, ',', '.') }}</dd>
                            </div>
                            <div>
                        ...
                        <dl class="space-y-4">
                            <div>
                                ...
                                <dd class="mt-1 text-sm">
                                    {{-- Restructured @switch for Transaction Status --}}
                                    @switch($transaction->status)
                                        ...
                                        @break
                                        @default
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text-gray-800 dark:bg-dark-subcard dark:text-gray-400">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm">
                                    {{-- Restructured @switch for Payment Status --}}
                                    @switch($transaction->payment_status)
                                        ...
                                        @case('refunded')
                                            ...
                                            @break
                                        @default {{-- Assuming default might be pending or similar --}}
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm">
                                     {{-- Restructured @switch for Shipping Status --}}
