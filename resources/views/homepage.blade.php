<x-app-layout>
    {{-- Frame untuk Turbo (opsional, berguna untuk search/pagination) --}}
    <turbo-frame id="products_list_frame">
        ...
        <div class="p-4 sm:p-6 bg-white dark:bg-dark-card rounded-2xl shadow-sm">
            ...
            <div id="product-list-content">
                <!-- Pencarian Server-Side (Tetap Ada) -->
                <form method="GET" action="{{ route('homepage') }}" class="relative mb-6" data-turbo-frame="products_list_frame">
                ...
                <div id="product-grid"
                    ...
                    @forelse ($products as $product)
                        <div class="bg-white dark:bg-dark-subcard rounded-xl shadow-md overflow-hidden flex flex-col group transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border border-gray-200 dark:border-dark-border hover:border-pink-300 dark:hover:border-pink-brand/50">
                            {{-- Link ke Detail Page pada Gambar - HAPUS @click --}}
                            ...
                            <div class="p-3 sm:p-4 flex flex-col flex-grow">
                                ...
                                {{-- Indikator Stok (Gunakan $product->total_stock dari query controller) --}}
                                ...
                                {{-- Tombol "Beli" Menjadi Link ke Detail - HAPUS @click dan :disabled --}}
                                <div class="mt-auto">
    ...
    {{-- Script Skeleton Loader (Tetap Ada) --}}
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                 ...
                 const showSkeleton = () => {
                    ...
                    const skeleton = getSkeletonContainer();
                 ...
                 const hideSkeleton = () => {
                    ...
                    if (content && content.style.display === 'none') {
                         content.style.display = 'block'; // Or appropriate display type
                    }
                 };
                 ...
                 document.addEventListener('turbo:before-fetch-request', (event) => {
                    if (isActualNavigation) { showSkeleton(); }
                 });
        ...
        {{-- Script untuk productList() AlpineJS TIDAK diperlukan lagi --}}
    @endpush
